...
HD_PWD='/projects/10_XADC/10_XADC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_MODULE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_MODULE.tcl
