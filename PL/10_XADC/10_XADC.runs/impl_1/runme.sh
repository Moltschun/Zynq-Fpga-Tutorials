...
HD_PWD='/projects/10_XADC/10_XADC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_MODULE.tcl -notrace
