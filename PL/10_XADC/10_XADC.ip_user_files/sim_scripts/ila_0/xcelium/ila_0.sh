...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../10_XADC.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../10_XADC.gen/sources_1/ip/ila_0/hdl/verilog" \
